...
function useMutationState(options = {}, queryClient) {
	...
	const result = (0, preact_hooks.useRef)(null);
	if (result.current === null) result.current = getResult(mutationCache, options);
	(0, preact_hooks.useEffect)(() => {
		optionsRef.current = options;
	});
	return require_utils.useSyncExternalStore((0, preact_hooks.useCallback)((onStoreChange) => mutationCache.subscribe(() => {
