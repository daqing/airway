...
function useMutation(options, queryClient) {
	...
	const result = require_utils.useSyncExternalStore((0, preact_hooks.useCallback)((onStoreChange) => observer.subscribe(_tanstack_query_core.notifyManager.batchCalls(onStoreChange)), [observer]), () => observer.getCurrentResult());
	const mutate = (0, preact_hooks.useCallback)((...args) => {
