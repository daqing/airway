...
//#region src/features/column-resizing/columnResizingFeature.types.d.ts
...
interface ColumnDef_ColumnResizing {
  /**
   * Enables or disables column resizing for the column.
   */
  enableResizing?: boolean;
}
interface Column_ColumnResizing {
  /**
...
interface Header_ColumnResizing {
  /**
...
//#endregion
export { ColumnDef_ColumnResizing, ColumnResizeDirection, ColumnResizeMode, ColumnResizingDefaultOptions, Column_ColumnResizing, Header_ColumnResizing, TableOptions_ColumnResizing, TableState_ColumnResizing, Table_ColumnResizing, columnResizingState };