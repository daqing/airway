...
features:
  - title: One CLI for everything
    details: Install with `go install github.com/daqing/airway@latest` — scaffold projects and plugins, generate code, and run migrations.
  - title: PostgreSQL, MySQL, SQLite
    details: One codebase, three databases. The driver is inferred from the DSN at runtime.
  - title: Plugins
    details: WordPress-style feature modules shipped as independent Go modules, enabled with a single blank import.
